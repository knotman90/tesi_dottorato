...
For example, the instruction might be \framebox{\texttt{add R3,R0}}.
...
\section{The OpenMP Parallel Computing Paradigm for Shared Memory Computers}
\label{sec:openmp}
