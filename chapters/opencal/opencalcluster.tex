...
Figure \ref{fig:julia_two_GPU_false} shows that fluctuation in this case are not present.
 ...
 \begin{table}[]
 	...
 	\begin{tabular}{@{}LLCC@{}}
 		\toprule
 		\multicolumn{2}{c}{\textbf{\textit{Workload}}}\\ \cline{1-2}
 		\textbf{ 980}& \textbf{K40} & \textbf{Time}$(\si{\milli\second})$ & \textbf{Speedup$(\times)$}  \\
 		
 		0     & 12000 & 2561  & 488.09 \\
 		1000  & 11000 & 2520  & 496.03 \\
 		2000  & 10000 & 2935  & 425.89 \\
 		\cellcolor{blue!25}3000  & \cellcolor{blue!25}9000  & \cellcolor{blue!25}2314  & \cellcolor{blue!25}540.19 \\
 ...
 \end{table}
   ...
   \begin{figure}
 	\begin{center}
 		\includegraphics[width=1.0\textwidth]{./plots/fractal12k_k40_980_true}
 		\caption{Domain decomposition along one axis.}
 ...
 \begin{figure}
 	\begin{center}
 		\includegraphics[width=1.0\textwidth]{./plots/fractal12k_k40_980_false}
 		\caption{Domain decomposition along one axis.}
