...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Considered Numerical Methods} 
...
\frame{\frametitle{Cellular Automata}
	\begin{itemize}
		\item \textbf{CA}\footnote{J. von Neumann (Edited and completed by A. Burks), Theory of self-reproducing
			automata, University of Illinois Press, 1966} are \textbf{discrete} \textbf{parallel} computational model, widely utilized in modeling and simulating of complex systems
...
\frame{\frametitle{Cellular Automata}
	\begin{itemize}
		\item CA are simple but complexity emerges even when the transition function is almost trivial
...
\item other schema are obtained likewise
	\end{itemize}
}
