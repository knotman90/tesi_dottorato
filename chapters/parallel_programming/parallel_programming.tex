...
\lettrine[lines=3,lhang=0.33,lraise=0,loversize=0.15]{T}{his} chapter introduces the parallel computing concepts and technologies that have been adopted in this work. It contains a description of the Flynn categorization of parallel machines and introduces \textsc{OpenMP}, \textsc{OpenCL} and \textsc{MPI}. 
